...
export const getData = async () => {
  ...
  try {
    const response = await axios.get('https://hiredgo.pythonanywhere.com/api/user_homepage/', {
      headers: {
...
export const updateUserHomepage = async (formData) => {
  try {
    const response = await axios.post('https://hiredgo.pythonanywhere.com/api/user_homepage/', formData);
    return {
      success: true,
